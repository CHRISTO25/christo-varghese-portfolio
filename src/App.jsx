...
export default function App() {
  ...
  // Official Formspree hook using your endpoint ID: mqpzpeod
  ...
  return (
    <div className="min-h-screen bg-[#030305] text-slate-100 font-sans selection:bg-amber-500 selection:text-black relative overflow-x-hidden">
      ...
      <div className="absolute top-0 left-1/3 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-[150px] pointer-events-none animate-pulse"></div>
      <div className="absolute top-1/4 right-10 w-[450px] h-[450px] bg-violet-600/10 rounded-full blur-[160px] pointer-events-none"></div>
      <div className="absolute bottom-1/3 left-10 w-[550px] h-[550px] bg-cyan-600/10 rounded-full blur-[180px] pointer-events-none"></div>

      {/* HEADER / NAVBAR */}
      <header className="sticky top-0 z-50 backdrop-blur-2xl bg-[#030305]/80 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <a href="#" className="text-xl font-black tracking-widest text-white flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center shadow-lg shadow-amber-500/30 group-hover:rotate-12 transition-transform">
              <Terminal className="w-5 h-5 text-black" />
            </div>
            <span>CHRISTO <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-orange-400 to-violet-500">VARGHESE</span></span>
          </a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#07070c] border-b border-white/10 px-6 py-6 flex flex-col gap-5 text-base font-semibold">
            <a href="#about" onClick={() => setMobileMenuOpen(false)} className="text-slate-300 hover:text-amber-400">ABOUT</a>
            <a href="#skills" onClick={() => setMobileMenuOpen(false)} className="text-slate-300 hover:text-amber-400">EXPERTISE</a>
            <a href="#projects" onClick={() => setMobileMenuOpen(false)} className="text-slate-300 hover:text-amber-400">PROJECTS</a>
            <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="text-slate-300 hover:text-amber-400">CONTACT</a>
          </div>
        )}
      </header>

      {/* HERO SECTION WITH HOLOGRAPHIC PHOTO & CONFIDENCE WRITING */}
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-32 grid md:grid-cols-12 gap-12 items-center relative z-10">
        <div className="md:col-span-7">
          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-amber-400 text-xs font-bold mb-6 tracking-widest uppercase shadow-2xl backdrop-blur-md">
            <Activity className="w-4 h-4 text-amber-400 animate-pulse" /> FULL-STACK ARCHITECT & BACKEND SPECIALIST
          </div>
          ...
          <div className="p-6 md:p-8 bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/15 rounded-3xl mb-8 backdrop-blur-xl shadow-2xl relative group hover:border-amber-500/50 transition-colors">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a 
              href="#projects" 
              className="px-8 py-4 rounded-2xl bg-gradient-to-r from-amber-400 via-orange-500 to-amber-500 text-black font-extrabold hover:brightness-110 transition-all flex items-center gap-2.5 shadow-2xl shadow-amber-500/25 transform hover:-translate-y-1"
            >
              Explore Portfolio <ChevronRight className="w-5 h-5" />
            </a>
            <a 
              href="#contact" 
              className="px-8 py-4 rounded-2xl bg-white/5 border border-white/15 text-slate-200 font-bold hover:bg-white/10 transition-all backdrop-blur-md"
            >
              Direct Contact
            </a>
          </div>
        ...
        <div className="md:col-span-5 flex justify-center">
          <div className="relative group">
            ...
            <div className="relative w-72 h-80 sm:w-80 sm:h-[440px] rounded-3xl overflow-hidden border-2 border-white/25 bg-[#07070c] shadow-2xl">
              <img 
                src="/PHOTO-2026-08-09-23-34-02.jpg" 
                alt="Christo Varghese" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 filter contrast-110 saturate-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#030305] via-transparent to-transparent opacity-90"></div>
              <div className="absolute bottom-6 left-6 right-6">
                <div className="p-4 rounded-2xl bg-black/60 backdrop-blur-md border border-white/15 shadow-xl">
                  <p className="text-white font-black text-lg tracking-wide">Christo Varghese</p>
                  <p className="text-amber-400 text-xs font-bold tracking-widest uppercase mt-0.5">Full-Stack & Backend Dev</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ABOUT SECTION */}
      <section id="about" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/10 relative">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-slate-300 leading-relaxed mb-4 text-base font-light">
            ...
            <p className="text-slate-400 leading-relaxed mb-8 text-sm font-light">
            ...
            <div className="flex items-center gap-4">
              <a href="https://github.com/CHRISTO25" target="_blank" rel="noopener noreferrer" className="px-6 py-3.5 bg-white/5 rounded-2xl border border-white/15 text-slate-200 hover:text-amber-400 hover:border-amber-500/50 transition-all text-sm font-bold flex items-center gap-2.5 shadow-lg">
                <ExternalLink className="w-4 h-4 text-amber-400" /> GitHub Profile: @CHRISTO25
              </a>
            </div>
          </div>
          
          <div className="bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-8 sm:p-10 rounded-[30px] border border-white/15 shadow-2xl backdrop-blur-xl relative overflow-hidden">
            ...
            <h3 className="text-2xl font-black text-white mb-6 flex items-center gap-3">
              <ShieldCheck className="w-7 h-7 text-amber-400" /> Core Competencies
            </h3>
            <ul className="space-y-4 text-slate-300 font-medium">
              <li className="flex items-center gap-3.5 p-3 rounded-xl bg-white/5 border border-white/5">
                <div className="w-2.5 h-2.5 rounded-full bg-amber-400 shadow-md shadow-amber-400/50"></div> 
                High-performance backend systems (Golang, Gin, Node.js)
              </li>
              <li className="flex items-center gap-3.5 p-3 rounded-xl bg-white/5 border border-white/5">
                <div className="w-2.5 h-2.5 rounded-full bg-orange-400 shadow-md shadow-orange-400/50"></div> 
                Relational & NoSQL database architecture (PostgreSQL, MongoDB)
              </li>
              <li className="flex items-center gap-3.5 p-3 rounded-xl bg-white/5 border border-white/5">
                <div className="w-2.5 h-2.5 rounded-full bg-violet-400 shadow-md shadow-violet-400/50"></div> 
      ...
      {/* SKILLS SECTION */}
      <section id="skills" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-block text-xs font-bold text-amber-400 tracking-widest uppercase mb-3 px-3 py-1 rounded-md bg-amber-500/10 border border-amber-500/20">
            TECHNICAL STACK
          </div>
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">Precision Frameworks & Tools</h2>
          <p className="text-slate-400">The battle-tested technologies used to build reliable production applications.</p>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-7 hover:border-amber-500/50 hover:bg-white/[0.06] transition-all duration-300 group shadow-xl">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-7 hover:border-violet-500/50 hover:bg-white/[0.06] transition-all duration-300 group shadow-xl">
            <div className="w-14 h-14 rounded-2xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center text-violet-400 mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-7 hover:border-emerald-500/50 hover:bg-white/[0.06] transition-all duration-300 group shadow-xl">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-7 hover:border-cyan-500/50 hover:bg-white/[0.06] transition-all duration-300 group shadow-xl">
      ...
      <section id="projects" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-2">Featured Projects</h2>
            <p className="text-slate-400">Production clones and custom backend microservices. Click to access repositories.</p>
          </div>
          <a 
            href="https://github.com/CHRISTO25" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="mt-4 md:mt-0 text-amber-400 hover:text-amber-300 font-bold flex items-center gap-2 text-sm group"
          >
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="p-8">
                ...
                <h3 className="text-2xl font-black text-white mb-3 group-hover:text-amber-400 transition-colors">{project.title}</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-6 font-light">{project.description}</p>
              </div>

              <div className="px-8 py-5 bg-black/50 border-t border-white/5 flex flex-wrap gap-2">
      ...
      <section id="contact" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/10">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="inline-block text-xs font-bold text-amber-400 tracking-widest uppercase mb-3 px-3 py-1 rounded-md bg-amber-500/10 border border-amber-500/20">
              GET IN TOUCH
            </div>
            <h2 className="text-4xl font-black tracking-tight mb-4">Let's Build Together</h2>
            ...
            <div className="space-y-4 text-slate-300">
              <div className="flex items-center gap-4 p-5 rounded-2xl bg-white/[0.03] border border-white/10 shadow-xl backdrop-blur-md">
                <div className="w-12 h-12 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400">
                  <Mail className="w-6 h-6" />
                </div>
                <div>
                  <p className="text-xs text-slate-500 uppercase tracking-widest font-black">Direct Email</p>
                  <a href="mailto:christovarghese2275@gmail.com" className="text-sm font-bold hover:text-amber-400 transition-colors">christovarghese2275@gmail.com</a>
                </div>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-white/[0.07] to-white/[0.02] border border-white/15 rounded-[30px] p-8 sm:p-10 backdrop-blur-2xl shadow-2xl relative">
            ...
            {state.succeeded ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-16">
                ...
                <h3 className="text-2xl font-black text-white mb-2">Message Dispatched Successfully!</h3>
      ...
      {/* FOOTER */}
      <footer className="border-t border-white/10 py-12 text-center text-slate-500 text-xs tracking-wider">
